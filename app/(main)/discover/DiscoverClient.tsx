        ...
        <div className="sticky top-0 bg-background-secondary border-b border-border-color px-4 py-4 z-10 shadow-xl">
          ...
          <div className="mt-3 flex justify-center">
            <div className="relative">
              ...
              >
                <option value={5}>0-5 mi (approx)</option>
                <option value={10}>0-10 mi (approx)</option>
                <option value={25}>0-25 mi (approx)</option>
                <option value={50}>0-50 mi (approx)</option>
                <option value={100}>0-100 mi (approx)</option>
              </select>
